...
namespace AwsomeBundle\Controller;

use AwsomeBundle\Entity\Message;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $messages = $em->getRepository('AwsomeBundle:Message')->findAll();
    ...
    {
        $message = new Message();
        $form = $this->createForm('AwsomeBundle\Form\MessageType', $message);
    ...
    {
        $deleteForm = $this->createDeleteForm($message);
        $editForm = $this->createForm('AwsomeBundle\Form\MessageType', $message);
